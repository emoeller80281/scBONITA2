...
DATA_FILE="input/atherosclerosis_dataset/combined_atherosclerosis_scRNAseq.csv"
DATASET_NAME="atherosclerosis" # Enter the name of your dataset
...
METADATA_FILE="input/atherosclerosis_dataset/combined_atherosclerosis_metadata.csv"
METADATA_SEP=","
...
GROUP_INDICES=(1) # Column 6 is "Atherosclerosis Status" (AS+ / AS-)
...
NUM_CELLS_TO_ANALYZE=9368 # The total number of cells to analyze
